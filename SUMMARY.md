...
* [Concurrent Programming](book/concurrent-programming/concurrent-programming.md)
  - [Actor model](book/concurrent-programming/actor-model.md)
    - [Actix actors](book/concurrent-programming/actix-actors.md)
